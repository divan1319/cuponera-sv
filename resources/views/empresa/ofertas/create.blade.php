...
<div class="mb-6 flex items-center gap-3">
    ...
    <h1 class="text-2xl font-bold text-slate-950">Nueva Oferta</h1>
</div>
        ...
        <form method="POST" action="{{ route('empresa.ofertas.store') }}">
            ...
            <div class="grid gap-4 md:grid-cols-12">
                ...
                <div class="md:col-span-6">
                    ...
                    <p class="mt-1 text-sm text-slate-500">Debe ser menor al precio regular.</p>
                ...
                <div class="md:col-span-4">
                    ...
                    <p class="mt-1 text-sm text-slate-500">Opcional. Deja vacío para sin límite.</p>
